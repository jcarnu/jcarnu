...
\mobile{+337.88.55.08.10}        
\email{jca@altidev.com}                      
\extrainfo{38 ans}
%\photo[64pt]{picture}     
...
\subsection{Altidev}
	\cventry{Depuis Septembre 2012}{Ingénieur développement}{}{}{}{
		\begin{itemize}
			...
			\item Continental : Afficheurs de production web, gestion des faits techniques sur ligne, interface usine/robot de découpe
