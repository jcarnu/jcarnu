...
\section{Compétences}
  ...
  \subsection{Système et réseau}
    ...
    \cvcomputer{Haute-disponibitlié}{Réplication PostgreSQL, DRBD, réplication et synchronisation applicative, heartbeat, peacemaker}{Réseaux}{Réseaux IPv4 et IPv6 avec gestion de la qualité de service, ATM (AAL3 à 5)}
  \subsection{Langues}
    \cvlanguage{Anglais}{lu, parlé, écrit}{}
    \cvlanguage{Allemand}{notions}{}
  
 \section{Centres d'intérêt}
  \cvline{Loisirs}{Astronomie, badminton, VTT, ski, guitare et lecture.}
