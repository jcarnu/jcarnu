...
\subsection{CS Système d'Information Toulouse}
              \cventry{Depuis Décembre 2008}{ Expert technique PostgreSQL et Logiciels libres}{niveau 3 (certification interne sur 4 niveaux)}{}{}{
                \begin{itemize}
              ...
              \end{itemize}}
              \cventry{Depuis Mars 2008}{Architecte du système mutualisé de production de logiciel du groupe CS}{}{}{}{
              \begin{itemize}
...
\section{Logiciel libre, communauté open-source}
  ...
  \cventry{2008 et 2010}{PGDay Europe, PGConfEurope}{Communauté PostgreSQL Europe, Italie, Stuttgart}{}{}{Conférence spécialisée autour de PostgreSQL, sa communauté et son éco-système.}
...
\section{Compétences}
  \subsection{Développement}
    \cvcomputer{Conception}{OMT, UML, SDL, HOOD}{SGBD}{\emph{PostgreSQL}, MySQL, Hadoop/HIVE}
    \cvcomputer{Langages}{Python, Java, C/C++, Bash}{Web}{DojoJS/XHTML/CSS, PHP}
  
  \subsection{Système et réseau}
    \cvcomputer{OS}{Linux (Debian/RedHat), Unix, Windows}{Plates-formes}{Apache HTTPD, OpenSSH, mod\_security2}
    ...
    \cvcomputer{Haute-disponibitlié}{Réplication PostgreSQL, DRBD, réplication et synchronisation applicative, heartbeat, pacemaker}{Réseaux}{Réseaux IPv4 et IPv6 avec gestion de la qualité de service, ATM (AAL3 à 5)}
  \subsection{Langues}
    \cvlanguage{Anglais}{lu, parlé, écrit}{}
    \cvlanguage{Allemand}{notions}{}
  
 \section{Centres d'intérêt}
  \cvline{Loisirs}{Astronomie, badminton, VTT, ski, guitare, cuisine et lecture.}
